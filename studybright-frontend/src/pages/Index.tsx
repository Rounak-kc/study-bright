        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          <div className="space-y-8">
            <div className="space-y-6">
              ...
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold tracking-tight">
                Your path to <span className="text-brand-800">success</span> starts here
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button asChild className="h-12 px-6 bg-brand-800 hover:bg-brand-600">
          ...
          <div className="hidden md:block relative">
            ...
            <div className="relative bg-white rounded-xl p-6 shadow-xl border border-gray-100 card-hover">
              <div className="absolute -top-3 -right-3 h-10 w-10 rounded-full bg-brand-800 flex items-center justify-center text-white font-semibold">
                #1
              </div>
              <div className="space-y-4">
                ...
                <div className="pt-2">
                  <Button className="w-full bg-brand-800 hover:bg-brand-600">Take Test</Button>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="bg-brand-50 py-16 md:py-24">
        <div className="container">
          <div className="flex flex-col items-center text-center space-y-6">
            ...
            <Button asChild className="h-12 px-6 bg-brand-800 hover:bg-brand-600 mt-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                <div className="h-8 w-8 rounded bg-brand-800 flex items-center justify-center">
                  <svg width="20" height="20" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M12 6L7 12H17L12 18" stroke="white" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
                <span className="text-xl font-semibold text-brand-800">TestPrep</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="/dashboard" className="hover:text-brand-800">Dashboard</Link></li>
                <li><Link to="/exams" className="hover:text-brand-800">Exams</Link></li>
                <li><Link to="/analytics" className="hover:text-brand-800">Analytics</Link></li>
              </ul>
            </div>
            <div>
              <h4 className="font-medium mb-4">Exams</h4>
              <ul className="space-y-2 text-sm text-muted-foreground">
                <li><Link to="#" className="hover:text-brand-800">SSC Exams</Link></li>
                <li><Link to="#" className="hover:text-brand-800">Banking Exams</Link></li>
                <li><Link to="#" className="hover:text-brand-800">Railway Exams</Link></li>
                <li><Link to="#" className="hover:text-brand-800">UPSC Exams</Link></li>
              </ul>
            </div>
            <div>
