    ...
    <div className="container py-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-brand-800">{recentResults.length}</div>
          </CardContent>
        </Card>
        <Card>
          <CardHeader className="pb-2">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-brand-800">2</div>
          </CardContent>
        </Card>
      </div>
            ...
            <div className="h-80 w-full">
              <ResponsiveContainer width="100%" height="100%">
                <BarChart data={performanceData} margin={{ top: 20, right: 30, left: 20, bottom: 20 }}>
                  ...
                  />
                  <Bar dataKey="score" fill="#0d4970" radius={[4, 4, 0, 0]} />
                </BarChart>
              </ResponsiveContainer>
            </div>
          </CardContent>
