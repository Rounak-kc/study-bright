    ...
    <div className="container py-8 animate-fade-in">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-brand-800">1,248</div>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-brand-800">72</div>
            <div className="text-sm text-muted-foreground">
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-brand-800">4,582</div>
            <div className="text-sm text-muted-foreground">
              Across all subjects
            </div>
          </CardContent>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-3xl font-bold text-brand-800">8,745</div>
            <div className="text-sm text-muted-foreground">
          ...
          <CardContent className="h-80">
            <ResponsiveContainer width="100%" height="100%">
              ...
              >
                ...
                />
                <Legend />
                <Bar name="Test Attempts" dataKey="value" fill="#0d4970" radius={[4, 4, 0, 0]} />
              </BarChart>
            </ResponsiveContainer>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <Card className="overflow-hidden card-hover">
          <CardHeader className="pb-2">
            <FileText className="h-8 w-8 text-brand-800 mb-2" />
          ...
          <CardFooter>
            <Button asChild className="w-full bg-brand-800 hover:bg-brand-700">
        ...
        <Card className="overflow-hidden card-hover">
          <CardHeader className="pb-2">
            <Database className="h-8 w-8 text-brand-800 mb-2" />
        ...
        <Card className="overflow-hidden card-hover">
          <CardHeader className="pb-2">
            <Users className="h-8 w-8 text-brand-800 mb-2" />
